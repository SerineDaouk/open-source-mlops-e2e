...
def load_test_parameters(params):
    ...
    return processed_data_dir, model_path, feat_cols, random_state
...
def create_reports_dir():
    ...
    return reports_dir, fig_dir

def eval(params):
    processed_data_dir, model_path, feat_cols, random_state = load_test_parameters(params)
    ...
    reports_dir, fig_dir = create_reports_dir()
    ...
    json.dump(
        obj=metrics,
        fp=open(f'{reports_dir}/metrics.json', 'w'),
        indent=4,
        sort_keys=True
    )
